...
) ENGINE=InnoDB AUTO_INCREMENT=1361 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='集團股分類目錄';
...
) ENGINE=InnoDB AUTO_INCREMENT=5322 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='股票與集團代碼';
...
) ENGINE=InnoDB AUTO_INCREMENT=4202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='概念股類別目錄';
...
CREATE TABLE IF NOT EXISTS `concept_stock` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `group_code_security_code` (`group_code`,`security_code`)
) ENGINE=InnoDB AUTO_INCREMENT=125713 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='概念股代碼與股票代碼';
...
) ENGINE=InnoDB AUTO_INCREMENT=160030 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='外資及陸資投資類股彙總持股比率表';
...
) ENGINE=InnoDB AUTO_INCREMENT=18869 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='市場成交資訊';
...
CREATE TABLE IF NOT EXISTS `investors` (
  ...
  `total_buy` decimal(15,2) NOT NULL DEFAULT 0.00 COMMENT '買超(股數)',
  `total_sell` decimal(15,2) NOT NULL DEFAULT 0.00 COMMENT '賣超(股數)',
  `difference` decimal(15,2) NOT NULL DEFAULT 0.00 COMMENT '買賣差(股數)',
  `type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT 'FD=外資 D=自營商 SITC=投信',
  `updown_times` int(11) DEFAULT NULL,
  `last_updown_times` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `security_code_traded_day_type` (`security_code`,`traded_day`,`type`)
) ENGINE=InnoDB AUTO_INCREMENT=5174528 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='三大法人買賣超';
...
CREATE TABLE IF NOT EXISTS `margin_transactions_all` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `security_code_traded_day` (`security_code`,`traded_day`)
) ENGINE=InnoDB AUTO_INCREMENT=4045383 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='融資融券彙總 (全部)';
...
) ENGINE=InnoDB AUTO_INCREMENT=14843 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='信用交易統計';
...
) ENGINE=InnoDB AUTO_INCREMENT=6881964 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='美日收盤價及每月均價';
...
) ENGINE=InnoDB AUTO_INCREMENT=730178 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='個股月成交資訊';
...
) ENGINE=InnoDB AUTO_INCREMENT=5412734 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='本益比 \r\n判斷公司股價是否合理，通常用來分析獲利穩定的公司。\r\n淨值比\r\n判斷公司股價是否合理，通常用來分析獲利不穩定或虧損的公司。\r\n殖利率\r\n年報酬率';
...
CREATE TABLE IF NOT EXISTS `short_sales_volume_and_value` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `security_code_traded_day` (`security_code`,`traded_day`)
) ENGINE=InnoDB AUTO_INCREMENT=2763863 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='當日融券賣出與借券賣出成交量值';
...
) ENGINE=InnoDB AUTO_INCREMENT=934851 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='股票基本資訊';
...
CREATE TABLE IF NOT EXISTS `stock_day` (
  ...
  `next_result` int(11) DEFAULT NULL COMMENT '0 平盤 -1 跌 1 漲',
  PRIMARY KEY (`id`),
  UNIQUE KEY `security_code_traded_day` (`security_code`,`traded_day`),
  ...
  KEY `change` (`change`)
) ENGINE=InnoDB AUTO_INCREMENT=9892723 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='盤後 日交易量';
...
CREATE TABLE IF NOT EXISTS `taiex` (
  ...
  `traded_day` int(11) NOT NULL DEFAULT 0 COMMENT '交易日',
  PRIMARY KEY (`id`),
  UNIQUE KEY `date_traded_day` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=5541 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='TAIEX  發行量加權股價指數歷史資料';

-- 取消選取資料匯出。
-- 傾印  表格 stock_tw.usd_ntd 結構
CREATE TABLE IF NOT EXISTS `usd_ntd` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `traded_day` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `USD` decimal(15,3) NOT NULL,
  `NTD` decimal(15,3) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `traded_day` (`traded_day`)
) ENGINE=InnoDB AUTO_INCREMENT=7508 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='貨幣';
...
) ENGINE=InnoDB AUTO_INCREMENT=552975 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='年度成交資訊';
